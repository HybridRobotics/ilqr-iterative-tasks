...
count = 0
with open("data/ego_nlmpc_ss_"+str(20)+"_no_obstacle.obj", "rb") as handle:
    ego = pkl.load(handle)
...
for point in num_point_lmpc:
    with open("data/ego_nlmpc_ss_"+str(point)+"_no_obstacle.obj", "rb") as handle:
        ego = pkl.load(handle)
...
for point in num_point_ilqr:
    with open("data/ego_ilqr_ss_"+str(point)+"_no_obstacle.obj", "rb") as handle:
        ego = pkl.load(handle)
...
plt.ylabel("$p_y$")
plt.tight_layout()
plt.savefig("media/no_obstacle_trajectory.png",format="png")
plt.show()
...
plt.tight_layout()
plt.savefig("media/no_obstacle_time.png",format="png")
plt.show()
...
with open("data/ego_nlmpc_ss_"+str(point)+"_no_obstacle.obj", "rb") as handle:
    ego = pkl.load(handle)
list_inputs_lmpc = (ego.data["input"][9])
list_states_lmpc = (ego.data["state"][9])
...
with open("data/ego_ilqr_ss_"+str(point)+"_no_obstacle.obj", "rb") as handle:
    ego = pkl.load(handle)
list_inputs_ilqr = (ego.data["input"][9])
list_states_ilqr = (ego.data["state"][9])
